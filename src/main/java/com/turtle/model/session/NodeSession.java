...
public final class NodeSession implements Comparable<NodeSession> {
     ...
     * <p>节点状态</p>
     */
    private NodeSession.Status status;
    ...
    private NodeSession(byte[] id, String host, int port) {
        ...
        this.host = host;
        this.port = port;
        this.status = NodeSession.Status.UNUSE;
    }
    ...
    public boolean useable() {
        return this.status != NodeSession.Status.VERIFY;
    }
    ...
    public boolean markVerify() {
        if(this.status == NodeSession.Status.UNUSE) {
            this.status = NodeSession.Status.VERIFY;
        }
        return true;
    }
     ...
     * @return 节点状态
     */
    public NodeSession.Status getStatus() {
        return status;
    }
     ...
     * @param status 节点状态
     */
    public void setStatus(NodeSession.Status status) {
        this.status = status;
    }
    ...
    public boolean equals(Object object) {
        ...
        if(object instanceof NodeSession) {
            return Arrays.equals(this.id, ((NodeSession) object).id);
        }
        return false;
    }
