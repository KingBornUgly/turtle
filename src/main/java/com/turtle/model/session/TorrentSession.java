...
import com.turtle.model.*;
import com.turtle.net.torrent.TorrentStreamGroup;
import com.turtle.net.torrent.dht.DhtLauncher;
import com.turtle.net.torrent.peer.PeerDownloaderGroup;
import com.turtle.net.torrent.peer.PeerSubMessageHandler;
import com.turtle.net.torrent.peer.PeerUploader;
import com.turtle.net.torrent.peer.PeerUploaderGroup;
import com.turtle.net.torrent.tracker.TrackerLauncherGroup;
import com.turtle.protocol.maget.MagnetBuilder;
import com.turtle.protocol.maget.TorrentBuilder;
...
public final class TorrentSession {
    ...
    private void loadExecutor() {
        this.executor = SystemThreadContext.newCacheExecutor(0, 60L, SystemThreadContext.TURTLE_THREAD_BT);
    }
    ...
    private void loadExecutorTimer() {
        this.executorTimer = SystemThreadContext.newTimerExecutor(2, SystemThreadContext.TURTLE_THREAD_BT_TIMER);
    }
