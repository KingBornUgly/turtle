...
public final class StunConfig {
     ...
     * <p>默认端口：{@value}</p>
     */
    public static final int DEFAULT_PORT = 3008;
    /**
     * <p>固定值：{@value}</p>
     */
    ...
    public enum MethodType {
         ...
         * <p>绑定：请求、响应、指示</p>
         *
         * @see StunConfig.MessageType#REQUEST
         * @see StunConfig.MessageType#INDICATION
         * @see StunConfig.MessageType#RESPONSE_SUCCESS
         * @see StunConfig.MessageType#RESPONSE_ERROR
         */
        BINDING((short) 0x01);
    ...
    public enum MessageType {
         ...
         * @return 消息类型标识
         */
        public short of(StunConfig.MethodType methodType) {
            return (short) (
                    (
                            ((this.id << 7) & C1_MASK) |
                                    ((this.id << 4) & C0_MASK) |
                                    methodType.id
                    ) & StunConfig.MessageType.TYPE_MASK);
        }
         ...
         * @return 方法类型
         */
        public static final StunConfig.MessageType of(short value) {
            final short type = (short) (value & StunConfig.MessageType.TYPE_MASK);
            final byte id = (byte) (((type & C1_MASK) >> 7) | ((type & C0_MASK) >> 4));
            final MessageType[] types = StunConfig.MessageType.values();
            for (StunConfig.MessageType messageType : types) {
    ...
    public enum AttributeType {
         ...
         * @return 属性类型
         */
        public static final StunConfig.AttributeType of(short id) {
            final AttributeType[] types = StunConfig.AttributeType.values();
            for (StunConfig.AttributeType attributeType : types) {
