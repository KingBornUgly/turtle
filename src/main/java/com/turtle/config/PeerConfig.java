 ...
 * Peer ID Conventions
 * 协议链接：http://www.bittorrent.org/beps/bep_0020.html
 */
public final class PeerConfig extends PropertiesConfig {
    ...
    private byte[] buildPeerId() {
        ...
        if(versionLength > PEER_ID_VERSION_LENGTH) {
            ...
            builder.append(StringUtils.repeat(PEER_ID_VERSION_LENGTH - versionLength,SymbolConfig.Symbol.ZERO.toString()));
        }
    ...
    public enum Type {
         ...
         * @return 协议消息类型
         */
        public static final PeerConfig.Type of(byte id) {
    ...
    public enum ExtensionType {
         ...
         * @return 扩展协议消息类型
         */
        public static final PeerConfig.ExtensionType of(byte id) {
            final ExtensionType[] types = PeerConfig.ExtensionType.values();
         ...
         * @return 扩展协议消息类型
         */
        public static final PeerConfig.ExtensionType of(String value) {
            final ExtensionType[] types = PeerConfig.ExtensionType.values();
            for (PeerConfig.ExtensionType type : types) {
    ...
    public enum MetadataType {
         ...
         */
        public static final PeerConfig.MetadataType of(byte id) {
            final MetadataType[] types = PeerConfig.MetadataType.values();
            for (PeerConfig.MetadataType type : types) {
                if(type.id == id) {
                    return type;
                }
            }
    ...
    public enum HolepunchType {
         ...
         */
        public static final PeerConfig.HolepunchType of(byte id) {
            final HolepunchType[] types = PeerConfig.HolepunchType.values();
            for (PeerConfig.HolepunchType type : types) {
                if(type.id == id) {
                    return type;
                }
            }
