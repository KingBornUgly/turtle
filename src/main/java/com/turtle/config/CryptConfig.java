...
public final class CryptConfig {
    ...
    public enum Strategy {
         ...
         * <p>明文</p>
         */
        PLAINTEXT(false, CryptConfig.CryptAlgo.PLAINTEXT.provide),
        /**
         * <p>偏爱明文</p>
         */
        PREFER_PLAINTEXT(false, CryptConfig.CryptAlgo.PLAINTEXT.provide | CryptConfig.CryptAlgo.ARC4.provide),
        /**
         * <p>偏爱加密</p>
         */
        PREFER_ENCRYPT(true, CryptConfig.CryptAlgo.ARC4.provide | CryptConfig.CryptAlgo.PLAINTEXT.provide),
        /**
         * <p>加密</p>
         */
        ENCRYPT(true, CryptConfig.CryptAlgo.ARC4.provide);
         ...
         *
         * @see CryptConfig.CryptAlgo#provide
         */
        private final int provide;
     ...
     * <p>默认加密策略</p>
     *
     * @see CryptConfig.Strategy
     */
    public static final CryptConfig.Strategy STRATEGY = CryptConfig.Strategy.PREFER_PLAINTEXT;
