...
public final class SystemConfig extends PropertiesConfig {
     ...
     */
    private void init() {
        this.name = this.getString("turtle.system.name");
        this.nameEn = this.getString("turtle.system.name.en");
        this.version = this.getString("turtle.system.version");
        this.ftpUser = this.getString("turtle.system.ftp.user");
        this.ftpPassword = this.getString("turtle.system.ftp.password");
        this.stunServer = this.getString("turtle.system.stun.server");
        this.servicePort = this.getInteger("turtle.service.port", 16888);
        this.torrentPort = this.getInteger("turtle.torrent.port", 18888);
        this.peerSize = this.getInteger("turtle.peer.size", 20);
        this.trackerSize = this.getInteger("turtle.tracker.size", 50);
        this.pieceRepeatSize = this.getInteger("turtle.piece.repeat.size", 8);
        this.hlsThreadSize = this.getInteger("turtle.hls.thread.size", 10);
        this.dhtInterval = this.getInteger("turtle.dht.interval", 120);
        this.pexInterval = this.getInteger("turtle.pex.interval", 120);
        this.lsdInterval = this.getInteger("turtle.lsd.interval", 120);
        this.haveInterval = this.getInteger("turtle.have.interval", 30);
        this.trackerInterval = this.getInteger("turtle.tracker.interval", 120);
        this.peerOptimizeInterval = this.getInteger("turtle.peer.optimize.interval", 60);
