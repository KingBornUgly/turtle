...
public final class DownloadConfig extends PropertiesConfig {
     ...
     * @see #path
     */
    private static final String DOWNLOAD_PATH = "turtle.download.path";
    /**
     * <p>下载数量配置名称：{@value}</p>
     *
     * @see #size
     */
    private static final String DOWNLOAD_SIZE = "turtle.download.size";
    /**
     * <p>消息提示配置名称：{@value}</p>
     *
     * @see #notice
     */
    private static final String DOWNLOAD_NOTICE = "turtle.download.notice";
    /**
     * <p>删除文件配置名称：{@value}</p>
     *
     * @see #delete
     */
    private static final String DOWNLOAD_DELETE = "turtle.download.delete";
    /**
     * <p>下载速度（单个）（KB）配置名称：{@value}</p>
     *
     * @see #buffer
     */
    private static final String DOWNLOAD_BUFFER = "turtle.download.buffer";
    /**
     * <p>最后一次选择目录配置名称：{@value}</p>
     *
     * @see #lastPath
     */
    private static final String DOWNLOAD_LAST_PATH = "turtle.download.last.path";
    /**
     * <p>磁盘缓存（单个）（MB）配置名称：{@value}</p>
     *
     * @see #memoryBuffer
     */
    private static final String DOWNLOAD_MEMORY_BUFFER = "turtle.download.memory.buffer";
