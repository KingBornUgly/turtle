//package com.torrent.event;
//
//import com.torrent.config.StunConfig;
...
//		final GuiContext.MessageType type = (GuiContext.MessageType) this.getArg(args, 2, GuiContext.MessageType.INFO);
