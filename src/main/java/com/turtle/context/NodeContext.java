...
import com.turtle.net.torrent.dht.DhtClient;
...
public final class NodeContext implements IContext {
    ...
    private void register() {
        final Map<String, String> defaultNodes = DhtConfig.getInstance().nodes();
