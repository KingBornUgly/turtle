...
import com.turtle.net.torrent.utp.UtpClient;
...
public final class HolepunchMessageHnadler extends ExtensionTypeMessageHandler {
	...
	public void doMessage(ByteBuffer buffer) {
		...
		final PeerConfig.HolepunchType holepunchType = PeerConfig.HolepunchType.of(typeId);
	 ...
	 * @return 消息
	 * 
	 * @see #buildMessage(PeerConfig.HolepunchType, String, int, PeerConfig.HolepunchErrorCode)
	 */
