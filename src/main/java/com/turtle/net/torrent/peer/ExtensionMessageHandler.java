...
public final class ExtensionMessageHandler implements IExtensionMessageHandler {
    ...
    public void onMessage(ByteBuffer buffer) throws NetException {
        ...
        final PeerConfig.ExtensionType extensionType = PeerConfig.ExtensionType.of(typeId);
    ...
    public void handshake() {
        ...
        this.pushMessage(PeerConfig.ExtensionType.HANDSHAKE.id(), BEncodeEncoder.encodeMap(message));
    }
