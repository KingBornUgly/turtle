...
import com.turtle.context.StunContext;
...
public final class StunMessageHandler extends UdpMessageHandler {
	 ...
	 * <p>发送映射消息</p>
	 * 
	 * @see StunConfig.AttributeType#MAPPED_ADDRESS
	 */
	 ...
	 * @param buffer 属性消息
	 * 
	 * @see StunConfig.AttributeType#XOR_MAPPED_ADDRESS
	 */
	 ...
	 * @param buffer 属性消息
	 * 
	 * @see StunConfig.AttributeType#ERROR_CODE
	 */
