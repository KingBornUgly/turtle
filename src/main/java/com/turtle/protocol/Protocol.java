...
public abstract class Protocol {
    ...
    public enum Type {
        ...
        public static final String buildMagnet(String hash) {
            ...
            return Protocol.Type.MAGNET.defaultPrefix + hash.toLowerCase();
        }
     ...
     * @param name 协议名称
     */
    protected Protocol(Protocol.Type type, String name) {
        this.type = type;
        this.name = name;
    }
